...
/*   Updated: 2023/08/05 15:49:37 by anvieira         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/cub.h"

static void map_position_square(t_player *player)
{
...
void dda(t_game *game)
{
    ...
    while (map[p->map_square.y][p->map_square.x] != '1')
    {
        ////////////////////////
        if (p->ray_dir.x == 0)
        {
        ...
        {
            p->dist_to_wallx += dist_to_wall_x(p);
            p->map_square.x += p->step_x;
            p->hit_side = 0;
        }
        else
        {
            p->dist_to_wally += dist_to_wall_y(p);
            p->map_square.y += p->step_y;
            p->hit_side = 1;
        }
    }
